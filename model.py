...
class GINConv(MessagePassing):
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        # print("self.edge_embedding1(edge_attr[:,0])",self.edge_embedding1(edge_attr[:,0]))
        # print("self.edge_embedding2(edge_attr[:,1])",self.edge_embedding2(edge_attr[:,1]))
...
class GNN(torch.nn.Module):
    ...
    def __init__(self, num_layer, emb_dim, JK = "last", drop_ratio = 0, gnn_type = "gin"):
        ...
        self.lin1 = torch.nn.Linear(emb_dim, emb_dim // 2)
        self.act = ShiftedSoftplus()
        self.lin2 = torch.nn.Linear(emb_dim // 2, 1)
