...
class MD17(InMemoryDataset):
    ...
    def process(self):
        ...
        for i in tqdm(range(len(E))):
            ...
            radius_graph = RadiusGraph(r=5.0, loop=True, max_num_neighbors=200)
            data = radius_graph(data)
            
            distance = Distance(norm=False)
            data = distance(data)  # edge_attr 对应原来的 edge_dist
